...
class StreamProcessor:
    ...
    def _load_conversation_history(self):
        ...
        if self.conversation_id and self.initial_user_id:
            ...
            self.history = limit_chat_history(json.loads(self.data.get("history", "[]")), gpt_model=self.model_id)
    ...
    def _configure_retriever(self):
        ...
        doc_token_limit = calculate_doc_token_budget(gpt_model=self.model_id, history_token_limit=history_token_limit)
