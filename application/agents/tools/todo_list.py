...
class TodoListTool(Tool):
    ...
    def execute_action(self, action_name: str, **kwargs: Any) -> Dict[str, Any]:
        ...
        Returns:
            A dictionary result with status_code and other fields.
        """
        if not self.user_id:
            return {"status_code": 400, "error": "TodoListTool requires a valid user_id."}

        # Strip 'todo_' prefix if present (e.g., 'todo_create' -> 'create')
    ...
    # -----------------------------
    @staticmethod
    def _coerce_todo_id(value: Any) -> Optional[int]:
        """Coerce various todo_id types to sequential integers."""
        if value is None:
            return None
    ...
    def _create(self, title: str, description: str = "") -> Dict[str, Any]:
        ...
        return {"status_code": 201, "todo_id": todo_id, "title": title, "description": description}
    ...
    def _update(self, todo_id: Optional[Any], updates: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not updates:
            return {"status_code": 400, "error": "Updates are required."}
        ...
        return {"status_code": 200, "message": f"Todo {parsed_todo_id} updated."}
    ...
    def _complete(self, todo_id: Optional[Any]) -> Dict[str, Any]:
        ...
        return {"status_code": 200, "message": f"Todo {parsed_todo_id} marked as completed."}
    ...
    def _delete(self, todo_id: Optional[Any]) -> Dict[str, Any]:
        ...
        return {"status_code": 200, "message": f"Todo {parsed_todo_id} deleted."}
